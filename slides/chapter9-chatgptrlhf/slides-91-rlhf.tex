...
\begin{figure}
\centering
\includegraphics[width = 10cm]{figure/instructgpttable3.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width = 10cm]{figure/questionsaboutcode.png}
\end{figure}
...
\item The reason could be that labelers rewards ``epistemic humility''.
\end{itemize}
...
\begin{figure}
\centering
\includegraphics[width = 5cm]{figure/harmfulpromptfollowing.png}
\end{figure}
...
\textbf{What we align to is determined by:}
	...
	\begin{itemize}
		\item The labelers (from US and Southeast Asia)
