...
\begin{minipage}[c]{.44\textwidth}
    ...
    \begin{figure}
        \centering
        \includegraphics{figure/mha.png}
...
\begin{minipage}[c]{.44\textwidth}
    ...
    \begin{figure}
        \centering
        \includegraphics{figure/ffn.png}
        \label{fig:enter-label}
    \end{figure}
    \vfill
\end{minipage}
...
\begin{figure}
    \centering
    \includegraphics[width=7cm]{figure/layernorm.png}    \label{fig:Layer Norm-label}
\end{figure}
