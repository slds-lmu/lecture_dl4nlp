...
\textbf{Relation to T0/T5/FLAN:} This earlier work (earlier
	than Ouyang et al., 2022) was similar in spirit, but
	was more in the tradition of NLP tasks. Each
	...
	of a task. In  (Ouyang et al., 2022), there is more
	fluidity and they include tasks like
	``brainstorming'' that are unlike traditional NLP
	tasks. Finally, InstructGPT only made sense for a
	very powerful model that already had all
	capabilities, they just needed to be
	exposed. T0/T5/FLAN were based on much weaker models.
...
\begin{figure}
\centering
\includegraphics[width = 10cm]{figure/cheat,on,exam.png}
\end{figure}
\vfill
\end{vbframe}
...
\textbf{Motivation (4c): Helpfulness in dialog}
	...
	\begin{itemize}
		...
		wrong. Here's why.'' is ok in some cultures,
		not ok in others. 
	\end{itemize}
...
\begin{vbframe}{SKIP THIS Main evaluation result}
...
\begin{vbframe}{SKIP Important hyperparameter: KL reward
	coefficient beta}
...
\begin{vbframe}{SKIP THIS: SFT vs PPO}
...
\begin{figure}
\centering
\includegraphics[width = 9cm]{figure/120characters.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width = 6cm]{figure/teenagesuicide}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width = 10cm]{figure/refusal,kala,pani.png}
\end{figure}
...
\item OpenAI: the pretraining data contain lots of examples
