...
figure/chain_of_thought
}{
\item illustrate \cotpfull and point out the benefits it brings to LMs
\item illustrate tree-of-thought and point out the benefits it brings to LMs 
}
...
\begin{frame}{LMs not good at reasoning tasks\\ (This is
    why we need \cotp.)}
...
\begin{itemize}
    ...
    term to refer to the idea of LMs using explicit
...
\begin{itemize}
    \item 1313837 \citebutton{https://app.sli.do/event/dinLdZRBHw2fXo5R31C3Nt}{https://app.sli.do/event/dinLdZRBHw2fXo5R31C3Nt}
    \item 1435969 \citebutton{https://app.sli.do/event/kWQDLpHa14256yiwxyCDr5}{https://app.sli.do/event/kWQDLpHa14256yiwxyCDr5}
    \item 4039244 \citebutton{https://app.sli.do/event/ef5nQS8XmbhWAQDVk9CYQs}{https://app.sli.do/event/ef5nQS8XmbhWAQDVk9CYQs}
    \item 42248917 \citebutton{https://app.sli.do/event/5YwPZfoEFAibQ4DbFTzfj2}{https://app.sli.do/event/5YwPZfoEFAibQ4DbFTzfj2}
\end{itemize}
