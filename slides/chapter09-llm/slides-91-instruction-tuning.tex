...
\begin{itemize}
    ...
    in QA
    \item This is not natural dialogic behavior: human
    typically don't
...
unsupervised training.
    \item \ques For which tasks is this expected to be the case
    / not the case?
...
\pause
    ...
    \item \ques \textbf{Why does this result in multi-task learning?}
...
\begin{itemize}
\item So a consistent format (as in T5) is desirable.
