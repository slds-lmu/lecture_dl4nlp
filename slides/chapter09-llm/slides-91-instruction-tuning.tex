...
%\item Very similar to (1) classification
    \item Agin, assumption: Model has learned about the task during (unsupervised) pre-training 
...
facilitate
        transfer to new tasks:  the model can generalize to new tasks by relying on the learned prompts and the ability to generate text outputs.
\end{itemize}
