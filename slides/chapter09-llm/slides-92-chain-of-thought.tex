...
\begin{frame}{CHANGE COT-P TO COT-FSP}
\end{frame}
...
\begin{frame}{Automatic verifier: AIME example}
...
\begin{frame}{One slide definition of RL}
...
\begin{frame}{\cotpfull motivation}
...
\begin{frame}{Examples of \cotpfull}
