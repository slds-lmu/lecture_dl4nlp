...
\item \textbf{We want to fix $N$ and $D$, so that we
...
\item In the future: \myblue{systems of smaller models}
        rather than
...
\href{https://www.youtube.com/watch?v=QgUj09K7vx4}{What is a trillion?}
