...
An \textit{Emergent ability} is an ability that is not present in small models but is present in large models. \vskip3mm
...
\begin{figure}
    \centering
    \includegraphics[width=0.84\textwidth]{chapters/chapter08/figure/emergent_abilities.png}
...
Observation: Emergent abilities appear only under metrics that nonlinearly or discontinuously scale model's per-token error rate:
...
\vfill
	...
	\begin{figure}
		\centering
		\includegraphics[width = 11cm]{chapters/chapter08/figure/emergent_experiments.png}\\ 
		\citebutton{Source: Schaeffer et al., 2023}{https://arxiv.org/pdf/2304.15004.pdf}
	\end{figure}
...
%
\item When choosing a metric, one should consider the metric's effect on the per-token error rate and adapt their measuring process accordingly
%
\end{itemize}
