...
\textbf{Lecturers and Tutors:}
	...
	\begin{itemize}
		...
		\item M.Sc. Yihong Liu (exercise sessions)
		\item Adrian Mülthaler (tutoring session \& exercise correction)
	\end{itemize}

\textbf{Time:}

	\begin{itemize}
		\item Lecture: Wednesday, 12.00 - 14.00
		\item Exercise: Tuesday, 16.00 - 18.00
		\item Tutoring: Tuesday, 14.00 - 16.00
	\end{itemize}
...
\textbf{Central other building blocks of the exercise:}
	...
	\begin{itemize}
		...
		\item Huggingface universe (week 3)
		\item Debugging (week 4)
		\item (public holiday in week 7)
