...
\begin{vbframe}{The Transformer architecture (1)}

\vfill

\begin{itemize}
	\item The Bahdanau model is still an RNN, just with attention on top.
	\item Architecture that consists of attention only: Transformer (Vaswani et al. (2017), ``Attention is all you need'')
\end{itemize}
